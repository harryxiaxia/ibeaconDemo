...
native_to_managed_trampoline_MonoTouch_UIKit_UIGestureRecognizer__UIGestureRecognizerDelegate_ShouldRecognizeSimultaneously (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_35, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_EstimoteBeaconProj_ChatSessionDelegate_DidStartReceivingResource (id this, SEL sel, id p0, NSString * p1, id p2, id p3)
{
	...
	NSObject *nsobj3 = (NSObject *) p3;
		...
		bool created3 = false;
		if (nsobj3) {
			mobj3 = get_nsobject_with_type_for_ptr_created (nsobj3, false, monotouch_get_parameter_type (method_41, 3), &created3);
		}
		arg_ptrs [3] = mobj3;
...
native_to_managed_trampoline_EstimoteBeaconProj_ChatSessionDelegate_DidFinishReceivingResource (id this, SEL sel, id p0, NSString * p1, id p2, id p3, id p4)
{
	...
	NSObject *nsobj2 = (NSObject *) p2;
		...
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_42, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
	NSObject *nsobj3 = (NSObject *) p3;
		MonoObject *mobj3 = NULL;
		bool created3 = false;
		if (nsobj3) {
			mobj3 = get_nsobject_with_type_for_ptr_created (nsobj3, false, monotouch_get_parameter_type (method_42, 3), &created3);
		}
		arg_ptrs [3] = mobj3;
	NSObject *nsobj4 = (NSObject *) p4;
		...
		bool created4 = false;
		if (nsobj4) {
			mobj4 = get_nsobject_with_type_for_ptr_created (nsobj4, false, monotouch_get_parameter_type (method_42, 4), &created4);
		}
		arg_ptrs [4] = mobj4;
...
native_to_managed_trampoline_EstimoteBeaconProj_ChatSessionDelegate_DidReceiveStream (id this, SEL sel, id p0, id p1, NSString * p2, id p3)
{
	...
	NSObject *nsobj3 = (NSObject *) p3;
		...
		bool created3 = false;
		if (nsobj3) {
			mobj3 = get_nsobject_with_type_for_ptr_created (nsobj3, false, monotouch_get_parameter_type (method_43, 3), &created3);
		}
		arg_ptrs [3] = mobj3;
...
native_to_managed_trampoline_EstimoteBeaconProj_AppDelegate_ReceivedLocalNotification (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_46, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_EstimoteBeaconProj_BeaconDelegateProximity_DidRangeBeacons (id this, SEL sel, id p0, id p1, id p2)
{
	...
	NSObject *nsobj2 = (NSObject *) p2;
		...
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_50, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_EstimoteBeaconProj_MyNearbyAdvertiserDelegate_DidReceiveInvitationFromPeer (id this, SEL sel, id p0, id p1, id p2, void * p3)
{
	...
	NSObject *nsobj2 = (NSObject *) p2;
		...
		arg_ptrs [2] = mobj2;
	if (p3)
		arg_ptrs [3] = (void*) get_delegate_for_block_parameter (method_52, 3, p3);
	else
		arg_ptrs [3] = NULL;
...
native_to_managed_trampoline_EstimoteBeaconProj_LabsTableViewDataSource_WillDisplay (id this, SEL sel, id p0, id p1, id p2)
{
	...
	NSObject *nsobj2 = (NSObject *) p2;
		...
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_67, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_Dialog_DialogViewController_Source_WillDisplay (id this, SEL sel, id p0, id p1, id p2)
{
	...
	NSObject *nsobj2 = (NSObject *) p2;
		...
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_159, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
void *
native_to_managed_trampoline_EstimoteBeaconProj_ProximityDemoViewController__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_EstimoteBeaconProj_BeaconScanGuide_get_blueBeacon (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_EstimoteBeaconProj_BeaconScanGuide_set_blueBeacon (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_EstimoteBeaconProj_BeaconScanGuide_get_greenBeacon (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_EstimoteBeaconProj_BeaconScanGuide_set_greenBeacon (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_EstimoteBeaconProj_BeaconScanGuide_get_purpleBeacon (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_EstimoteBeaconProj_BeaconScanGuide_set_purpleBeacon (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_EstimoteBeaconProj_BeaconScanGuide_DidReceiveMemoryWarning (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_EstimoteBeaconProj_BeaconScanGuide_ViewDidLoad (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
native_to_managed_trampoline_MonoTouch_MessageUI_Mono_MFMailComposeViewControllerDelegate__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_190));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_MessageUI_Mono_MFMailComposeViewControllerDelegate_Finished (id this, SEL sel, id p0, int p1, id p2)
{
	...
	NSObject *nsobj2 = (NSObject *) p2;
		...
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_191, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_Dialog_DialogViewController_SizingSource_GetHeightForRow (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_213, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_Dialog_GlassButton_BeginTracking (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_216, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_Dialog_GlassButton_EndTracking (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_217, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_Dialog_GlassButton_ContinueTracking (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_218, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	void* retval = (void *) mono_runtime_invoke (method_218, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
static MTClassMap __monotouch_class_map [] = {
	...
	{"BeaconScanGuide", "EstimoteBeaconProj.BeaconScanGuide, EstimoteBeaconProj", 0},
...
static MTClass __monotouch_classes [] = {
	...
	{"EstimoteBeaconProj.EventListViewController_iPhone+EventBeaconManagerDelegate", "NSObject", 1, 2, 0},
	{"EstimoteBeaconProj.CalendarViewDelegate", "NSObject", 1, 1, 0},
	{"EstimoteBeaconProj.BeaconDelegate", "NSObject", 1, 1, 0},
	...
	{"ProximityDemoViewController", "UIViewController", 1, 6, 0},
	{"BeaconScanGuide", "UIViewController", 1, 8, 0},
...
static MTMethod __monotouch_methods [] = {
	...
	{"init","@@:",0, &native_to_managed_trampoline_EstimoteBeaconProj_ProximityDemoViewController__ctor},
	...
	{"blueBeacon","@@:",0, &native_to_managed_trampoline_EstimoteBeaconProj_BeaconScanGuide_get_blueBeacon},
	{"setBlueBeacon:","v@:@",0, &native_to_managed_trampoline_EstimoteBeaconProj_BeaconScanGuide_set_blueBeacon},
	{"greenBeacon","@@:",0, &native_to_managed_trampoline_EstimoteBeaconProj_BeaconScanGuide_get_greenBeacon},
	{"setGreenBeacon:","v@:@",0, &native_to_managed_trampoline_EstimoteBeaconProj_BeaconScanGuide_set_greenBeacon},
	{"purpleBeacon","@@:",0, &native_to_managed_trampoline_EstimoteBeaconProj_BeaconScanGuide_get_purpleBeacon},
	{"setPurpleBeacon:","v@:@",0, &native_to_managed_trampoline_EstimoteBeaconProj_BeaconScanGuide_set_purpleBeacon},
	{"didReceiveMemoryWarning","v@:",0, &native_to_managed_trampoline_EstimoteBeaconProj_BeaconScanGuide_DidReceiveMemoryWarning},
	{"viewDidLoad","v@:",0, &native_to_managed_trampoline_EstimoteBeaconProj_BeaconScanGuide_ViewDidLoad},
...
int __monotouch_map_count = 166;
static int __monotouch_class_count = 67;
